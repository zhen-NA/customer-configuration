function customer_prompt_login --description "customer function: display user name for the prompt"
    ...
    echo -n -s (set_color $fish_color_user) "$USER" @ (prompt_hostname) (set_color normal)
end
